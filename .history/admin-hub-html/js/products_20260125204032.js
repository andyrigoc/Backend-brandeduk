                    ...
                    <div class="bulk-buttons">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a href="#" class="dropdown-item" onclick="applyBulkAction('export')">Export Selected</a>
                                <a href="#" class="dropdown-item" onclick="applyBulkAction('best-sellers')">Add to Best Sellers</a>
                ...
                <div class="products-table-wrapper">
                    <table class="products-table">
                        ...
                        <tbody id="productsTableBody">
                            <tr><td colspan="9" class="loading-cell"><i class="fas fa-spinner fa-spin"></i> Loading products...</td></tr>
                        </tbody>
                    </table>
                </div>
...
function openProductDetail(code, event) {
    ...
    // Open API endpoint in new tab to see full product data
